package pogi.tiger.com.sph.view.fragment.dummy;
...
import pogi.tiger.com.sph.utils.FakePostGenerator;
...
public class DummyContent {
    ...
    static {
        ITEMS = FakePostGenerator.generatePostList(COUNT);
...
//        ITEMS.add(item);
    ...
    private static Post createDummyItem(int position) {
        return new Post(String.valueOf(position), makeDetails(position));
    }
